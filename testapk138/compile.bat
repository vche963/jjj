...
set PACKAGE_PATH=com/example/testapk138
set PACKAGE=com.example.testapk138
...
%JAVAVM% -jar %JACK_JAR% --output-dex "%DEV_HOME%\bin" -cp %ANDROID_JAR% -D jack.java.source.version=1.8 "%DEV_HOME%\src\com\example\testapk138\R.java" "%DEV_HOME%\src\com\example\testapk138\MainActivity.java"
