...
set PACKAGE_PATH=com/example/elit2020m
set PACKAGE=com.example.elit2020m
...
%JAVAVM% -jar %JACK_JAR% --output-dex "%DEV_HOME%\bin" -cp %ANDROID_JAR% -D jack.java.source.version=1.8 "%DEV_HOME%\src\com\example\elit2020m\R.java" "%DEV_HOME%\src\com\example\elit2020m\MainActivity.java"
