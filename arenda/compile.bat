...
set PACKAGE_PATH=com/example/arenda
set PACKAGE=com.example.arenda
...
%JAVAVM% -jar %JACK_JAR% --output-dex "%DEV_HOME%\bin" -cp %ANDROID_JAR% -D jack.java.source.version=1.8 "%DEV_HOME%\src\com\example\arenda\R.java" "%DEV_HOME%\src\com\example\arenda\MainActivity.java"
