...
set PACKAGE_PATH=com/example/arendan
set PACKAGE=com.example.arendan
...
%JAVAVM% -jar %JACK_JAR% --output-dex "%DEV_HOME%\bin" -cp %ANDROID_JAR% -D jack.java.source.version=1.8 "%DEV_HOME%\src\com\example\arendan\R.java" "%DEV_HOME%\src\com\example\arendan\MainActivity.java"
